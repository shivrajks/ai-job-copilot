...
import { Loader2, Brain, MessageSquare, BarChart3, CheckCircle2 } from 'lucide-react';

const steps = [
  { icon: Brain, label: 'Analyzing resume and job requirements' },
  { icon: MessageSquare, label: 'Generating questions' },
  { icon: BarChart3, label: 'Preparing suggested answers' },
  { icon: CheckCircle2, label: 'Finalizing interview session' },
];
