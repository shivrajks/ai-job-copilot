...
interface TailorExperienceCardProps {
...
export function TailorExperienceCard({
  change,
  index,
  accepted,
  onAccept,
  onReject,
}: TailorExperienceCardProps) {
  return (
    <div
      className={cn(
      ...
      <div className="px-4 py-3 bg-accent/30 border-b border-border flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            aria-label="Accept experience change"
          >
          ...
          <button
            ...
            aria-label="Reject experience change"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
